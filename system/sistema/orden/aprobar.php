...
<?php
    ...
    if($editar==1){
        paraTodos::arrayUpdate("req_estatus=3", "requisicion", "req_codigo=$codigo");
    }
?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table class="table table-hover" id="requisicion">
                        ...
                        <tbody>
                            <?php
                            $consulrequisicion = paraTodos::arrayConsulta("*", "requisicion r,producto p, partidas", "r.req_procodigo=p.prod_codigo and r.req_unicodigo=$unidad and prod_partida=part_codigo and req_estatus=1");
